...
retNg,
ret;
return metaId ? delete options.wjMetadataId : metaId = Object.getPrototypeOf(target.prototype).constructor, metaData = wjNg2Meta.MetaFactory.getMetaData(metaId), options.inputs = (options.inputs || [WjDirectiveBehavior.parPropAttr]).concat(metaData.props.map(function(propDesc)
{
return propDesc.propertyName
})), changeEventsMap = Ng2Utils.getChangeEventMap(metaData), options.outputs = (options.outputs || []).concat(Ng2Utils.initEvents(target, changeEventsMap)), target[Ng2Utils.directiveTypeDataProp] = new DirectiveTypeData(metaData, changeEventsMap, options.wjParentDirectives, options.wjSiblingDirectiveId), retNg = options.wjIsDirective ? ng2.Directive(options) : ng2.Component(options), ret = retNg(target, targetKey), new MethodProxy(target, 'ngOnInit', WjDirectiveBehavior.prototype.dirOnInit), new MethodProxy(target, 'ngOnDestroy', WjDirectiveBehavior.prototype.dirOnDestroy), new MethodProxy(target, 'ngOnChanges', WjDirectiveBehavior.prototype.dirOnChanges), ret
}
});
...
System.register("wijmo/wijmo.angular2.input", ['angular2/core', 'wijmo/wijmo.angular2.directiveBase'], function(exports_1)
{
var __extends=this && this.__extends || function(d, b)
{
function __()
...
return __extends(WjComboBox, _super), __decorate([wijmo_angular2_directiveBase_1.WjComponent({selector: 'wj-combo-box'}), core_1.View({template: ""}), __param(0, core_3.Inject(core_2.ElementRef)), __param(1, core_3.Inject(core_2.Injector))], WjComboBox)
...
return __extends(WjAutoComplete, _super), __decorate([wijmo_angular2_directiveBase_1.WjComponent({selector: 'wj-auto-complete'}), core_1.View({template: ""}), __param(0, core_3.Inject(core_2.ElementRef)), __param(1, core_3.Inject(core_2.Injector))], WjAutoComplete)
...
return __extends(WjCalendar, _super), __decorate([wijmo_angular2_directiveBase_1.WjComponent({selector: 'wj-calendar'}), core_1.View({template: ""}), __param(0, core_3.Inject(core_2.ElementRef)), __param(1, core_3.Inject(core_2.Injector))], WjCalendar)
...
return __extends(WjColorPicker, _super), __decorate([wijmo_angular2_directiveBase_1.WjComponent({selector: 'wj-color-picker'}), core_1.View({template: ""}), __param(0, core_3.Inject(core_2.ElementRef)), __param(1, core_3.Inject(core_2.Injector))], WjColorPicker)
...
return __extends(WjInputMask, _super), __decorate([wijmo_angular2_directiveBase_1.WjComponent({selector: 'wj-input-mask'}), core_1.View({template: ""}), __param(0, core_3.Inject(core_2.ElementRef)), __param(1, core_3.Inject(core_2.Injector))], WjInputMask)
...
return __extends(WjInputColor, _super), __decorate([wijmo_angular2_directiveBase_1.WjComponent({selector: 'wj-input-color'}), core_1.View({template: ""}), __param(0, core_3.Inject(core_2.ElementRef)), __param(1, core_3.Inject(core_2.Injector))], WjInputColor)
...
return __extends(WjMultiSelect, _super), __decorate([wijmo_angular2_directiveBase_1.WjComponent({selector: 'wj-multi-select'}), core_1.View({template: ""}), __param(0, core_3.Inject(core_2.ElementRef)), __param(1, core_3.Inject(core_2.Injector))], WjMultiSelect)
...
return __extends(WjInputNumber, _super), __decorate([wijmo_angular2_directiveBase_1.WjComponent({selector: 'wj-input-number'}), core_1.View({template: ""}), __param(0, core_3.Inject(core_2.ElementRef)), __param(1, core_3.Inject(core_2.Injector))], WjInputNumber)
...
return __extends(WjInputDate, _super), __decorate([wijmo_angular2_directiveBase_1.WjComponent({selector: 'wj-input-date'}), core_1.View({template: ""}), __param(0, core_3.Inject(core_2.ElementRef)), __param(1, core_3.Inject(core_2.Injector))], WjInputDate)
...
return __extends(WjInputTime, _super), __decorate([wijmo_angular2_directiveBase_1.WjComponent({selector: 'wj-input-time'}), core_1.View({template: ""}), __param(0, core_3.Inject(core_2.ElementRef)), __param(1, core_3.Inject(core_2.Injector))], WjInputTime)
...
return __extends(WjInputDateTime, _super), __decorate([wijmo_angular2_directiveBase_1.WjComponent({selector: 'wj-input-date-time'}), core_1.View({template: ""}), __param(0, core_3.Inject(core_2.ElementRef)), __param(1, core_3.Inject(core_2.Injector))], WjInputDateTime)
...
return __extends(WjListBox, _super), __decorate([wijmo_angular2_directiveBase_1.WjComponent({selector: 'wj-list-box'}), core_1.View({template: "<div><ng-content></ng-content></div>"}), __param(0, core_3.Inject(core_2.ElementRef)), __param(1, core_3.Inject(core_2.Injector))], WjListBox)
}(wijmo.input.ListBox);
...
selector: 'wj-menu', changeDetection: core_4.ChangeDetectionStrategy.OnPush
}), core_1.View({
template: "<div><ng-content></ng-content></div>", directives: [core_2.forwardRef(function()
{
return WjMenuItem
})]
}), __param(0, core_3.Inject(core_2.ElementRef)), __param(1, core_3.Inject(core_2.Injector)), __param(2, core_3.Inject(ngCore.ApplicationRef)), __param(3, core_3.Inject(ngCore.ChangeDetectorRef))], WjMenu)
}(wijmo.input.Menu);
...
wjMetadataId: 'MenuItem', wjParentDirectives: [WjMenu], wjSiblingDirectiveId: 'menuItemDir', selector: 'wj-menu-item'
}), core_1.View({
template: "<template [wjMenuItemTemplateDir]><ng-content></ng-content></template>", directives: [core_2.forwardRef(function()
{
return WjMenuItemTemplateDir
})]
}), __param(0, core_3.Inject(core_2.ElementRef)), __param(1, core_3.Inject(core_2.Injector)), __param(2, core_3.Inject(core_2.ViewContainerRef)), __param(3, core_3.Inject(core_2.AppViewManager)), __param(4, core_3.Inject(core_2.Renderer))], WjMenuItem)
}();
...
wjMetadataId: 'MenuSeparator', wjParentDirectives: [WjMenu], wjSiblingDirectiveId: 'menuItemDir', selector: 'wj-menu-separator'
}), core_1.View({
template: "<template [wjMenuItemTemplateDir]><div class=\"wj-state-disabled\" style=\"width:100%;height:1px;background-color:lightgray\"></div></template>", directives: [core_2.forwardRef(function()
{
return WjMenuItemTemplateDir
})]
}), __param(0, core_3.Inject(core_2.ElementRef)), __param(1, core_3.Inject(core_2.Injector)), __param(2, core_3.Inject(core_2.ViewContainerRef)), __param(3, core_3.Inject(core_2.AppViewManager)), __param(4, core_3.Inject(core_2.Renderer))], WjMenuSeparator)
}(WjMenuItem);
...
}, __decorate([wijmo_angular2_directiveBase_1.WjComponent({selector: 'wj-popup'}), core_1.View({template: "<div><ng-content></ng-content></div>"}), __param(0, core_3.Inject(core_2.ElementRef)), __param(1, core_3.Inject(core_2.Injector))], WjPopup)
}(wijmo.input.Popup);
...
wjMetadataId: 'CollectionViewNavigator', selector: 'wj-collection-view-navigator'
...
return __decorate([wijmo_angular2_directiveBase_1.WjComponent({
wjMetadataId: 'CollectionViewPager', selector: 'wj-collection-view-pager'
...
return __extends(WjFlexGrid, _super), __decorate([wijmo_angular2_directiveBase_1.WjComponent({selector: 'wj-flex-grid'}), core_1.View({template: "<div><ng-content></ng-content></div>"}), __param(0, core_3.Inject(core_2.ElementRef)), __param(1, core_3.Inject(core_3.Injector))], WjFlexGrid)
}(wijmo.grid.FlexGrid);
...
selector: 'wj-flex-grid-column', wjParentDirectives: [WjFlexGrid]
}), core_1.View({template: "<div><ng-content></ng-content></div>"}), __param(0, core_3.Inject(core_2.ElementRef)), __param(1, core_3.Inject(core_3.Injector))], WjFlexGridColumn)
}(wijmo.grid.Column);
...
bbb = !0
}, __decorate([core_3.ContentChildren(core_2.TemplateRef)], WjTemplateCmp.prototype, "contentChildren", void 0), __decorate([core_3.ViewChildren(core_2.TemplateRef)], WjTemplateCmp.prototype, "viewChildren", void 0), __decorate([core_1.Component({selector: 'wj-template-cmp'}), core_1.View({template: "<template>Hey: <ng-content></ng-content></template>"}), __param(0, core_3.Inject(core_2.ElementRef)), __param(1, core_3.Inject(core_3.Injector)), __param(2, core_3.Inject(core_2.ViewContainerRef)), __param(3, core_3.Inject(core_2.TemplateRef)), __param(3, core_3.Optional()), __param(4, core_3.Query(core_2.TemplateRef))], WjTemplateCmp)
}();
...
{
function WjFlexGridFilter(elRef, injector, flexGrid)
{
_super.call(this, flexGrid);
wijmo_angular2_directiveBase_1.WjDirectiveBehavior.attach(this, elRef, injector)
}
...
}), __param(0, core_1.Inject(core_1.ElementRef)), __param(1, core_1.Inject(core_1.Injector)), __param(2, core_1.Inject(wijmo_angular2_grid_1.WjFlexGrid))], WjFlexGridFilter)
...
{
function WjFlexGridDetail(_viewContainerRef, _templateRef, _domRenderer, elRef, injector, flexGrid)
{
_super.call(this, flexGrid);
this._viewContainerRef = _viewContainerRef;
this._templateRef = _templateRef;
this._domRenderer = _domRenderer;
...
{
var templ=wijmo_angular2_directiveBase_1.WjDirectiveBehavior.instantiateTemplate(_this.flexGrid.hostElement, _this._viewContainerRef, _this._templateRef, _this._domRenderer),
...
}), __param(0, core_1.Inject(core_1.ViewContainerRef)), __param(1, core_1.Inject(core_1.TemplateRef)), __param(2, core_1.Inject(core_1.Renderer)), __param(3, core_1.Inject(core_1.ElementRef)), __param(4, core_1.Inject(core_1.Injector)), __param(5, core_1.Inject(wijmo_angular2_grid_1.WjFlexGrid))], WjFlexGridDetail)
...
{
function WjSheet(elRef, injector, _flexSheet)
{
_super.call(this, _flexSheet);
this._flexSheet = _flexSheet;
wijmo_angular2_directiveBase_1.WjDirectiveBehavior.attach(this, elRef, injector)
}
...
selector: 'wj-sheet', template: ""
}), __param(0, core_1.Inject(core_1.ElementRef)), __param(1, core_1.Inject(core_1.Injector)), __param(2, core_1.Inject(WjFlexSheet))], WjSheet)
...
}), __decorate([wijmo_angular2_directiveBase_1.WjComponent({selector: 'wj-flex-chart'}), core_1.View({template: ""}), __param(0, core_1.Inject(core_2.ElementRef)), __param(1, core_1.Inject(core_2.Injector))], WjFlexChart)
...
}), __decorate([wijmo_angular2_directiveBase_1.WjComponent({selector: 'wj-flex-pie'}), core_1.View({template: ""}), __param(0, core_1.Inject(core_2.ElementRef)), __param(1, core_1.Inject(core_2.Injector))], WjFlexPie)
}(wijmo.chart.FlexPie);
...
}), core_1.View({template: ""}), __param(0, core_1.Inject(core_2.ElementRef)), __param(1, core_1.Inject(core_2.Injector))], WjFlexChartAxis)
}(wijmo.chart.Axis);
...
}), core_1.View({template: ""}), __param(0, core_1.Inject(core_2.ElementRef)), __param(1, core_1.Inject(core_2.Injector))], WjFlexChartLegend)
}(wijmo.chart.Legend);
...
selector: 'wj-flex-chart-data-label', wjParentDirectives: [WjFlexChart]
}), core_1.View({template: ""}), __param(0, core_1.Inject(core_2.ElementRef)), __param(1, core_1.Inject(core_2.Injector))], WjFlexChartDataLabel)
...
selector: 'wj-flex-pie-data-label', wjParentDirectives: [WjFlexPie]
}), core_1.View({template: ""}), __param(0, core_1.Inject(core_2.ElementRef)), __param(1, core_1.Inject(core_2.Injector))], WjFlexPieDataLabel)
...
selector: 'wj-flex-chart-series', wjParentDirectives: [WjFlexChart, ], wjSiblingDirectiveId: 'series'
}), core_1.View({template: ""}), __param(0, core_1.Inject(core_2.ElementRef)), __param(1, core_1.Inject(core_2.Injector))], WjFlexChartSeries)
}(wijmo.chart.Series);
...
}), core_1.View({template: ""}), __param(0, core_1.Inject(core_2.ElementRef)), __param(1, core_1.Inject(core_2.Injector))], WjFlexChartLineMarker)
...
}), core_1.View({template: ""}), __param(0, core_1.Inject(core_2.ElementRef)), __param(1, core_1.Inject(core_2.Injector))], WjFlexChartDataPoint)
...
}), core_1.View({template: ""}), __param(0, core_1.Inject(core_2.ElementRef)), __param(1, core_1.Inject(core_2.Injector))], WjFlexChartPlotArea)
...
selector: 'wj-flex-chart-annotation-layer', wjParentDirectives: [wijmo_angular2_chart_1.WjFlexChart, ], template: ""
...
return __extends(WjLinearGauge, _super), __decorate([wijmo_angular2_directiveBase_1.WjComponent({selector: 'wj-linear-gauge'}), core_1.View({template: "<div><ng-content></ng-content></div>"}), __param(0, core_1.Inject(core_1.ElementRef)), __param(1, core_1.Inject(core_1.Injector))], WjLinearGauge)
...
return __extends(WjBulletGraph, _super), __decorate([wijmo_angular2_directiveBase_1.WjComponent({selector: 'wj-bullet-graph'}), core_1.View({template: "<div><ng-content></ng-content></div>"}), __param(0, core_1.Inject(core_1.ElementRef)), __param(1, core_1.Inject(core_1.Injector))], WjBulletGraph)
...
return __extends(WjRadialGauge, _super), __decorate([wijmo_angular2_directiveBase_1.WjComponent({selector: 'wj-radial-gauge'}), core_1.View({template: "<div><ng-content></ng-content></div>"}), __param(0, core_1.Inject(core_1.ElementRef)), __param(1, core_1.Inject(core_1.Injector))], WjRadialGauge)
...
selector: 'wj-range', wjParentDirectives: [WjLinearGauge, WjBulletGraph, WjRadialGauge]
}), core_1.View({template: ""}), __param(0, core_1.Inject(core_1.ElementRef)), __param(1, core_1.Inject(core_1.Injector))], WjRange)
}(wijmo.gauge.Range);
