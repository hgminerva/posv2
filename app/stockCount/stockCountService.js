    ...
    return {
        ...
        execute: function() {
            StockCountService = (function () {
                ...
                StockCountService.prototype.initCombobox = function (component, cmb) {
                    var url = localStorage.getItem('api_url') + StockCountService.API_URL_USER + 'list';
                    var headers = new http_1.Headers({
                        'Authorization': 'Bearer ' + localStorage.getItem('access_token')
                    });
                ...
                StockCountService.prototype.updatePageButtons = function (component) {
                ...
                StockCountService.API_URL_USER = "/api/user/";
