System.register(['angular2/core', 'angular2/router', 'angular2/http', 'angular2/common', 'rxjs/Rx', '../home/home', '../login/login', '../logout/logout', '../dashboard/dashboard', '../profile/profile', '../item/item', '../item/ItemAdd', '../pos/pos', '../posTouch/posTouch', '../salesReports/salesReports', '../discounting/discounting', '../discounting/discountingAdd', '../collection/collection', '../collection/collectionAdd', '../itemGroup/itemGroup', '../itemGroup/itemGroupAdd', '../collectionReports/collectionReports', '../customer/customer', '../customer/customerAdd', '../purchases/purchases', '../purchases/purchasesAdd', '../itemComponents/itemComponents', '../receivable/receivable', '../supplier/supplier', '../supplier/supplierAdd', '../disbursement/disbursement', '../disbursement/disbursementAdd', '../restaurantTables/restaurantTables', '../restaurantTables/restaurantTablesAdd', '../debitCreditMemo/debitCreditMemo', '../debitCreditMemo/debitCreditMemoAdd', '../systemTables/systemTables', '../stockIn/stockIn', '../stockIn/stockInAdd', '../inventory/inventory', '../disbursementReports/disbursementReports', '../users/users', '../users/usersAdd', '../stockOut/stockOut', '../stockOut/stockOutAdd', '../stockCount/stockCount', '../stockCount/stockCountAdd', '../accountingReports/accountingReports', '../settings/settings', '../posReports/posReports', '../8mmPosReports/8mmPosReports', '../posTouch/posTouchDetail'], function(exports_1, context_1) {
    ...
    var core_1, router_1, http_1, common_1, Rx_1, home_1, login_1, logout_1, dashboard_1, profile_1, item_1, ItemAdd_1, pos_1, posTouch_1, salesReports_1, discounting_1, discountingAdd_1, collection_1, collectionAdd_1, itemGroup_1, itemGroupAdd_1, collectionReports_1, customer_1, customerAdd_1, purchases_1, purchasesAdd_1, itemComponents_1, receivable_1, supplier_1, supplierAdd_1, disbursement_1, disbursementAdd_1, restaurantTables_1, restaurantTablesAdd_1, debitCreditMemo_1, debitCreditMemoAdd_1, systemTables_1, stockIn_1, stockInAdd_1, inventory_1, disbursementReports_1, users_1, usersAdd_1, stockOut_1, stockOutAdd_1, stockCount_1, stockCountAdd_1, accountingReports_1, settings_1, posReports_1, _8mmPosReports_1, posTouchDetail_1;
    var App;
    return {
        setters:[
            function (core_1_1) {
            ...
            function (restaurantTablesAdd_1_1) {
                restaurantTablesAdd_1 = restaurantTablesAdd_1_1;
            },
            function (debitCreditMemo_1_1) {
                debitCreditMemo_1 = debitCreditMemo_1_1;
            },
            function (debitCreditMemoAdd_1_1) {
                debitCreditMemoAdd_1 = debitCreditMemoAdd_1_1;
            },
            ...
            function (stockInAdd_1_1) {
                stockInAdd_1 = stockInAdd_1_1;
            },
            ...
            function (usersAdd_1_1) {
                usersAdd_1 = usersAdd_1_1;
            },
            function (stockOut_1_1) {
                stockOut_1 = stockOut_1_1;
            },
            function (stockOutAdd_1_1) {
                stockOutAdd_1 = stockOutAdd_1_1;
            },
            function (stockCount_1_1) {
                stockCount_1 = stockCount_1_1;
            },
            function (stockCountAdd_1_1) {
                stockCountAdd_1 = stockCountAdd_1_1;
            },
            ...
            function (posTouchDetail_1_1) {
                posTouchDetail_1 = posTouchDetail_1_1;
            }],
        execute: function() {
            App = (function () {
                function App(_http) {
                ...
                App = __decorate([
                    ...
                    router_1.RouteConfig([{ path: '/home', name: 'Home', component: home_1.HomeComponent, useAsDefault: true },
                        ...
                        { path: '/addRestaurantTables', name: 'RestaurantTablesAdd', component: restaurantTablesAdd_1.RestaurantTablesAddComponent },
                        { path: '/debitCreditMemo', name: 'DebitCreditMemo', component: debitCreditMemo_1.DebitCreditMemoComponent },
                        { path: '/addDebitCreditMemo', name: 'DebitCreditMemoAdd', component: debitCreditMemoAdd_1.DebitCreditMemoAddComponent },
                        ...
                        { path: '/addStockIn', name: 'StockInAdd', component: stockInAdd_1.StockInAddComponent },
                        ...
                        { path: '/addUser', name: 'UsersAdd', component: usersAdd_1.UsersAddComponent },
                        { path: '/stockOut', name: 'StockOut', component: stockOut_1.StockOutComponent },
                        { path: '/addStockOut', name: 'StockOutAdd', component: stockOutAdd_1.StockOutAddComponent },
                        { path: '/stockCount', name: 'StockCount', component: stockCount_1.StockCountComponent },
                        { path: '/addStockCount', name: 'StockCountAdd', component: stockCountAdd_1.StockCountAddComponent },
                        ...
                        { path: '/posTouchDetail', name: "PosTouchDetail", component: posTouchDetail_1.PosTouchDetailComponent }
                    ]), 
