System.register(['angular2/core', 'angular2/http', '../response/response'], function(exports_1, context_1) {
    ...
    return {
        ...
        execute: function() {
            ItemGroupService = (function () {
                function ItemGroupService(http) {
                    this.http = http;
                }
                ItemGroupService.prototype.listItemGroup = function (component) {
                    var _this = this;
                    var url = localStorage.getItem('api_url') + ItemGroupService.API_URL_ITEM_GROUP + "list";
                ...
                ItemGroupService.prototype.updatePageButtons = function (component) {
            ...
            exports_1("ItemGroupService", ItemGroupService);
        }
    }
});
//# sourceMappingURL=itemGroupService.js.map