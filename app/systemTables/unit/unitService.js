    ...
    return {
        ...
        execute: function() {
            UnitService = (function () {
                ...
                UnitService.prototype.listUnit = function (component) {
                    var _this = this;
                    var url = localStorage.getItem('api_url') + UnitService.API_URL_UNIT + "list";
                ...
                UnitService.prototype.updatePageButtons = function (component) {
                    var currentPage = component.getUnitView().pageIndex;
                    var totalPage = component.getUnitView().pageCount;
                ...
                UnitService.API_URL_UNIT = "/api/unit/";
